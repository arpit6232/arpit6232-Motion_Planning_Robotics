...
def config():
    ...
    WO1_1 = Polygon([[1, 1], [2, 1], [2, 5], [1, 5], [1, 1]])
    WO1_2 = Polygon([[3, 4], [4, 4], [4, 12], [3, 12], [3, 4]])
    ...
    WO2_4 = Polygon([[4, -5], [5, -5], [5, 1], [4, 1]])
    WO2_5 = Polygon([[9, 0], [10, 0], [10, 5], [9, 5]])
    WO2_6 = Polygon([[14, -5], [15, -5], [15, 1], [14, 1]])
    WO2_7 = Polygon([[19, 0], [20, 0], [20, 5], [19, 5]])
    WO2_8 = Polygon([[24, -5], [25, -5], [25, 1], [24, 1]])
    WO2_9 = Polygon([[29, 0], [30, 0], [30, 5], [29, 5]])  
    ...
    DEFAULT_TEST_CONFIG = {
            ...
            'WO2': MultiPolygon([WO2_1, WO2_2, WO2_3,WO2_10, WO2_4, WO2_5, WO2_6, WO2_7,WO2_8, WO2_9]),
